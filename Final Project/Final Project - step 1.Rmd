...
## Research Questions
1. Are there other types of predictive analysis that will give us better results?
2. What are some variables that can help reduce heart disease?
3. What are the leading risk factors that cause heart disease?
4. What more can I add to the model to make it representative of the entire world, not just the U.S. population? Perhaps more data from different parts of the world or their diet?
5. How effective is the model when considering family history and genetic?
6. How can factors such as menopause in women affect the criteria of model?
